...
from vehicle.views import CarViewSet, MotoCreateAPIView, MotoListAPIView, MotoRetrievetAPIView, MotoUpdateAPIView, \
    MotoDestroyAPIView
...
urlpatterns = [
                  ...
                  path('moto/<int:pk>', MotoRetrievetAPIView.as_view(), name='moto_get'),
